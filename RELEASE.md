...
Maintainer-facing notes for cutting a NextNote (PolyForm Noncommercial 1.0.0) release. Works for ad-hoc-signed distribution (free Apple ID / no developer program needed). If you later enroll in the Apple Developer Program, the notarization steps at the bottom become relevant.
